...
namespace de
{
	namespace vk
	{
		...
		void device::create_device( )
		{
			...
			for ( auto i = 0; i < m_instance.configuration( ).layer_names.size( ); ++i )
				l_layer_strings.push_back( m_instance.configuration( ).layer_names[ i ].c_str( ) );
			...
			for ( auto i = 0; i < m_instance.configuration( ).extension_names.size( ); ++i )
				l_extension_strings.push_back( m_instance.configuration( ).extension_names[ i ].c_str( ) );
