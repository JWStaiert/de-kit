...
class de__vk__instance_test : public de__log__test
{
public:

	de::vk::loader m_loader;

	de__vk__instance_test( )
		: de__log__test { }
		, m_loader      { DE_VULKAN_LOADER_MODULE_PATHNAME }
	{
	}

	virtual ~de__vk__instance_test( )
	{
	}
...
TEST_F( de__vk__instance_test , ctor_debug_utils_config_success )
{
	try
	{
...
TEST_F( de__vk__instance_test , ctor_debug_report_utils_config_success )
{
	try
	{
