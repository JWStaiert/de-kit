...
namespace de
{
	namespace util
	{
		...
		template<>
		constexpr bool functions<std::int8_t>::is_signed( ) noexcept
		{
			return true;
		}
		template<>
		constexpr bool functions<std::int16_t>::is_signed( ) noexcept
		{
			return true;
		}
		template<>
		constexpr bool functions<std::int32_t>::is_signed( ) noexcept
		{
			return true;
		}
		template<>
		constexpr bool functions<std::int64_t>::is_signed( ) noexcept
		{
			return true;
		}
		template<>
		constexpr bool functions<std::uint8_t>::is_signed( ) noexcept
		{
			return false;
		}
		template<>
		constexpr bool functions<std::uint16_t>::is_signed( ) noexcept
		{
			return false;
		}
		template<>
		constexpr bool functions<std::uint32_t>::is_signed( ) noexcept
		{
			return false;
		}
		template<>
		constexpr bool functions<std::uint64_t>::is_signed( ) noexcept
		{
			return false;
		}

		template<>
		constexpr int functions<std::int8_t>::digits10( ) noexcept
		{
			return 3;
		}
		template<>
		constexpr int functions<std::int16_t>::digits10( ) noexcept
		{
			return 5;
		}
		template<>
		constexpr int functions<std::int32_t>::digits10( ) noexcept
		{
			return 10;
		}
		template<>
		constexpr int functions<std::int64_t>::digits10( ) noexcept
		{
			return 19;
		}
		template<>
		constexpr int functions<std::uint8_t>::digits10( ) noexcept
		{
			return 3;
		}
		template<>
		constexpr int functions<std::uint16_t>::digits10( ) noexcept
		{
			return 5;
		}
		template<>
		constexpr int functions<std::uint32_t>::digits10( ) noexcept
		{
			return 10;
		}
		template<>
		constexpr int functions<std::uint64_t>::digits10( ) noexcept
		{
			return 20;
		}

		template<>
		constexpr int functions<std::int8_t>::digits16( ) noexcept
		{
			return 2;
		}
		template<>
		constexpr int functions<std::int16_t>::digits16( ) noexcept
		{
			return 4;
		}
		template<>
		constexpr int functions<std::int32_t>::digits16( ) noexcept
		{
			return 8;
		}
		template<>
		constexpr int functions<std::int64_t>::digits16( ) noexcept
		{
			return 16;
		}
		template<>
		constexpr int functions<std::uint8_t>::digits16( ) noexcept
		{
			return 2;
		}
		template<>
		constexpr int functions<std::uint16_t>::digits16( ) noexcept
		{
			return 4;
		}
		template<>
		constexpr int functions<std::uint32_t>::digits16( ) noexcept
		{
			return 8;
		}
		template<>
		constexpr int functions<std::uint64_t>::digits16( ) noexcept
		{
			return 16;
		}
		...
		public:
			...
			template<typename T>
			void append_decimal( const T p_value ) noexcept;

			template<typename T>
			void append_hexadecimal( const T p_value ) noexcept;
