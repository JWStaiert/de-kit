...
/* */
#define DE__EXCEPTION__ASSERT( assertion ) if ( ! ( assertion ) ) { DE__EXCEPTION__THROW_LOGIC_ERROR( #assertion ); }

/* */
#define DE__EXCEPTION__ASSERT_WITH_MESSAGE( assertion , message ) if ( ! ( assertion ) ) { DE__EXCEPTION__THROW_LOGIC_ERROR_WITH_MESSAGE( #assertion , message ); }

/* */
#define DE__EXCEPTION__CHECK( expression ) if ( expression ) { DE__EXCEPTION__THROW_RUNTIME_ERROR( #expression ); }

/* */
#define DE__EXCEPTION__CHECK_WITH_MESSAGE( expression , message ) if ( expression ) { DE__EXCEPTION__THROW_RUNTIME_ERROR_WITH_MESSAGE( #expression , message ); }
